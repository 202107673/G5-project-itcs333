...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $db->prepare("INSERT INTO notes (course_code, course_name, course_description, course_type, course_date) 
                                VALUES (:course_code, :course_name, :course_description, :course_type, :course_date)");
